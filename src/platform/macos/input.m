...
#define set_name(keyname) \
	...
	break;
			...
			case 0x5D: set_name("kp9")
   			case 0x7B: set_name("f1")
			case 0x79: set_name("f2")
			case 0x64: set_name("f3")
			case 0x77: set_name("f4")
			case 0x61: set_name("f5")
			case 0x62: set_name("f6")
			case 0x63: set_name("f7")
			case 0x65: set_name("f8")
			case 0x66: set_name("f9")
			case 0x6E: set_name("f10")
			case 0x68: set_name("f11")
			case 0x70: set_name("f12")
			case 0x6A: set_name("f13")
			case 0x6C: set_name("f14")
			case 0x72: set_name("f15")
			case 0x6B: set_name("f16")
			case 0x41: set_name("f17")
			case 0x50: set_name("f18")
#undef set_name
		}
